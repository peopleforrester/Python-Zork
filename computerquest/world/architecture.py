...
class ComputerArchitecture:
    ...
    def bind_puzzles(self):
        ...
        self.rooms["core2_alu"].puzzles = ["pipeline_load_use"]
        self.rooms["core2_registers"].puzzles = ["pipeline_double_load_use"]
        self.rooms["core1_registers"].puzzles = ["pipeline_regfile_timing"]
        self.rooms["l2_cache1"].puzzles = ["l2_fifo_eviction"]
        self.rooms["l3_cache"].puzzles = ["l3_loop_pathology"]
        ...
        self.rooms["kernel"].puzzles = ["signature_near_miss", "signature_rootkit_hunt"]
